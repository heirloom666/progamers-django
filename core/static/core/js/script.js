...
function previewImage(event) {
  ...
  if (input.files && input.files[0]) {
      ...
      reader.onload = function (e) {
          ...
          imgPreview.setAttribute('class', 'img-fluid');
          imgPreview.setAttribute('style', 'max-width: 100%; max-height: 220px;');
          document.getElementById('cuadro-imagen').src = e.target.result; // Actualiza la imagen de perfil actual en tiempo real
      };
