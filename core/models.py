...
class Perfil(models.Model):
    ...
    def __str__(self):
        subscrito_str = 'subscrito' if self.subscrito else 'no subscrito'
        return f'{self.usuario.first_name} {self.usuario.last_name} (ID {self.id} - {self.tipo_usuario} {subscrito_str})'
